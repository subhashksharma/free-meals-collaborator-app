...
class Routes {
  ...
  public routes(app: any): void {
    ...
    app
      ...
      .post(this.controller.addSuperHero); // following code is to handle http://localhost:3000/superHero/{superHeroId} request.
    app.route("/superHero/:superHeroId").get(this.controller.getSuperHeroById);
